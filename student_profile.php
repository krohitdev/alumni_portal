...
if(isset($_GET["view_astudent"]) && isset($_GET["id"]) )
{
		...
		$result = $obj->select_record("student",$where);
          ...
          <div class="panel panel-info">
            ...
            <div class="panel-body">
              <div class="row">
				...
				<img alt="User Pic" src="../gentelella-master/production/student_upload/<?php echo $row['email'];?>/<?php echo $row['img'];?>" class="img-rounded img-responsive example-image img img-thumbnail"> 
				</a></div>
